            ...
            <main className={`bg-white lg:overflow-x-hidden`}>
                <section className='lg:flex lg:items-center lg:justify-center lg:w-screen lg:h-screen' >
                    <div className=" w-[95%] md:w-[407px] mt-16 lg:mt-0 mx-auto ">
                        <Image src={Urbanfit_logo} className={`${router.pathname === '/login' ? 'hidden' : ''} mx-auto mb-3`} />
                    ...
                    <div className=" w-[95%] md:w-[400px] mx-auto py-7 bg-white">
                        <Image src={Urbanfit_logo} className={`${router.pathname === '/login' ? '' : 'hidden'} mx-auto mb-12`} />
                        ...
                        <form className="bg-white p-2 font_futuraLT" onSubmit={onsubmit} >
                            ...
                            <Button value={router.pathname === '/login' ? 'Login' : 'Sign Up'} classes='w-full' />
                            ...
                            <div className={`${router.pathname === '/login' ? 'hidden' : ''} ${inter.className} w-full mt-5 flex justify-center space-x-6`}>
                ...
                <div className=" w-full my-5 px-10 flex flex-col lg:flex-row justify-between lg:space-x-3">
                    ...
                    <Button value="Terms and Condition" classes='w-full' />
                </div>
            </main>
        </>
    )
